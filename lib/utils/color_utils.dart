...
class ColorUtils {
  ...
  static Color blendColors(Color color1, Color color2, double ratio) {
    final r = ((color1.r * 255.0) * (1 - ratio) + (color2.r * 255.0) * ratio).round();
    final g = ((color1.g * 255.0) * (1 - ratio) + (color2.g * 255.0) * ratio).round();
    final b = ((color1.b * 255.0) * (1 - ratio) + (color2.b * 255.0) * ratio).round();
  ...
  static double getColorDistance(Color color1, Color color2) {
    final r1 = (color1.r * 255.0).round();
    final g1 = (color1.g * 255.0).round();
    final b1 = (color1.b * 255.0).round();
    final r2 = (color2.r * 255.0).round();
    final g2 = (color2.g * 255.0).round();
    final b2 = (color2.b * 255.0).round();
