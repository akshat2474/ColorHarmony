...
class _PaletteGeneratorScreenState extends State<PaletteGeneratorScreen>
              ...
              child: GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: color,
                    border: Border(
                      right: isLast ? BorderSide.none : const BorderSide(color: Colors.black, width: 3),
                    ),
                  ),
                  child: Center(
                    child: Column(
    ...
    return Column(
      ...
      children: [
        ...
        Slider(
          ...
          inactiveColor: AppConstants.primaryColor.withValues(alpha:0.3),
        ),
      ],
    );
  }
  ...
  Widget _buildColorListItem(int index) {
    ...
    return Container(
      ...
      child: ListTile(
        leading: custom_color_swatch.ColorSwatch(
          color: color,
          size: 40,
          showHex: false,
