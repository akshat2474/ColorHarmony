    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          unselectedLabelColor: ColorUtils.getContrastingTextColor(_selectedColor).withValues(alpha:0.7),
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'RGB(${(_selectedColor.r * 255.0).round()}, ${(_selectedColor.g * 255.0).round()}, ${(_selectedColor.b * 255.0).round()})',
                    style: TextStyle(
                      color: ColorUtils.getContrastingTextColor(_selectedColor),
                      fontSize: 14,
                    ),
